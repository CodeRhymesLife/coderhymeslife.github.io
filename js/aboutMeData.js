    ...
    content: [
        {
            ...
            text: "My latest research explores ways to improve medical education using augmented reality (AR) and virtual reality (VR)." +
				...
				"FMA Explorer in VR (and eventual AR): (<a href='FMAExplorer/Web/Web.html' target='_blank'>Web</a>) (<a href='FMAExplorer/Windows/FMAExplorer.zip' download>Windows</a>) (<a href='FMAExplorer/Mac/FMAExplorer.zip' download>Mac</a>)<br><br>" +
