...
aboutMeData.cv = {
    ...
    header: {
        ...
        website: "http://drryanjames.github.io"
    },
    content: [
        {
            sections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            link: "https://github.com/drryanjames/SemGen-Composer",
                            description: {
    ...
    content: [
        ...
        },
        {
            ...
            text: "KC is where it all started. I remember the first day I got my drivers license: the day I put it in my wallet was the same day I got my first speeding ticket (sorry Dad). " +
                ...
                "<a href='http://loynorrixhighschool.net/'  target='_blank'>that school on Kilgore</a> :). Go Giants!",
        },
    ],
};
    ...
    content: [
        {
            ...
            text: "My latest research explores ways to improve medical education and planning using augmented reality (AR), virtual reality (VR), natural input, and mathematical models of physiology. " +
				"Learning and working in AR and VR opens up new dimensions for input, and adds a spatial element that makes things easier to understand and remember. " +
				"It also adds a level of realism to experiences by placing students/trainees/workers inside of digital environments. Here's what I've been working on:<br><br><br>" +
        ...
        },
        {
            ...
            text: "\"<a href='http://sbp.bhi.washington.edu/projects/semgen'  target='_blank'>SemGen</a> is an experimental software tool for automating the modular composition and decomposition of biosimulation models\" -http://sbp.bhi.washington.edu/projects/semgen" +
                ...
                "A year later, during my first couple of quarters at UW working with the <a href='http://sbp.bhi.washington.edu/'  target='_blank'>Semantics of Biological Processes group</a>, I implemented the first version of the \"stage\" in SemGen. " +
                "Check out v1 (in test mode) below! For more information about SemGen and the \"stage\" <a href='http://sbp.bhi.washington.edu/projects/semgen'  target='_blank'>click here</a>" +
